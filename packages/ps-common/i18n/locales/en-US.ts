export const enUS = {
  ...
  'provider.comfyui.description': 'Powerful node-based workflow engine',
  'provider.replicate.description': 'Cloud-based AI model service platform',
  'provider.runninghub.description': 'Local AI service runner',
